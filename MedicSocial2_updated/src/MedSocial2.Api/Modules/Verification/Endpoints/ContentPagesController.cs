        ...
        <article class="legal-page-shell">
          ...
          <div class="legal-grid">
            <aside class="legal-nav">
              ...
              <a href="#terms-due-diligence">Due diligence and fraud risk</a>
              <a href="#terms-intermediary">Platform role</a>
              <a href="#terms-billing">Billing and payments</a>
              <a href="#terms-social">Feed and messaging</a>
              <a href="#terms-liability">Liability</a>
              <a href="#terms-indemnity">Indemnity</a>
            ...
            <div class="legal-content-card">
              ...
              <section id="terms-employers"><h2>Employer responsibilities</h2><ul><li>Employers must provide accurate facility, registration, licence, tax, contact, and job-posting information.</li><li>Employer team members must only access applicant details, documents, communications, and candidate discovery features for legitimate hiring activity.</li><li>Before making an offer or engagement, employers must independently establish a professional's identity, current licence and registration status, qualifications, references, authority to work, suitability, and any other matter material to the role.</li></ul></section>
              <section id="terms-professionals"><h2>Professional responsibilities</h2><p>Professionals must keep biodata, education, qualifications, licences, experience, skills, and uploaded proof documents accurate and current. Before accepting or acting upon an opportunity, professionals must independently establish the employer's identity, legal existence where applicable, authority to hire, facility details, working conditions, role requirements, offer terms, contract terms, and the identity and authority of each person with whom they deal.</p></section>
              <section id="terms-due-diligence"><h2>User due diligence, fraud risk and platform disclaimer</h2><p>Employers and professionals must exercise independent judgment and conduct careful due diligence before making or accepting any offer, signing a contract, attending a workplace, providing services, disclosing sensitive information, transferring money, or otherwise relying on another user. Users must remain alert to fraud, impersonation, falsified credentials, misleading job or facility information, payment scams, unsafe workplaces, misconduct, and contractual or workplace disputes. No profile, document, badge, status, search result, message, introduction, or other platform feature is a warranty that a user, credential, facility, opportunity, representation, or transaction is genuine, accurate, lawful, safe, suitable, or current. Each user bears responsibility for independently verifying all material information and deciding whether and how to proceed.</p><div class="legal-callout"><strong>Stay alert:</strong> Do not rely solely on information presented through MedicSocial. Confirm identities and authority through independent channels, verify professional licences with the relevant regulator, check references and facilities, review written offer and contract terms carefully, and independently confirm payment instructions before taking action.</div></section>
              <section id="terms-intermediary"><h2>Platform role and off-platform dealings</h2><p>MedicSocial provides technology that enables users to discover profiles and opportunities and make initial connections. MedicSocial is an intermediary only. It is not an employer, recruitment or employment agency, contracting party, guarantor, professional regulator, credentialing body, background-check provider, or professional-verification authority, and it does not make hiring, engagement, clinical, workplace, or payment decisions for users. After users connect, subsequent conversations, checks, negotiations, offers, contracts, payments, work, and other dealings are expected to occur independently and may take place outside the platform. MedicSocial does not supervise, direct, control, monitor, or routinely follow up on those dealings and does not determine whether an employment, locum, or other engagement was concluded, performed, safe, satisfactory, or successful. Any agreement is solely between the relevant employer and professional.</p></section>
              ...
              <section id="terms-liability"><h2>Disclaimer and limitation of liability</h2><p>To the fullest extent permitted by applicable law, MedicSocial and its present or future operators, administrators, developers, representatives, service providers, successors, and affiliates (together, the “Platform Parties”) provide the platform, user-supplied content, introductions, and related features on an “as is” and “as available” basis, without any warranty or guarantee concerning identity, credentials, accuracy, authenticity, conduct, safety, suitability, availability, outcome, or payment. The Platform Parties are not responsible for the acts, omissions, statements, content, offers, decisions, workplaces, services, payments, or disputes of users or other third parties, including fraud, impersonation, credential falsification, scams, unsafe conditions, misconduct, non-payment, breach of contract, or unsuccessful employment or locum proceedings. To the fullest extent permitted by applicable law, the Platform Parties will not be liable for losses arising from or connected with user-to-user or off-platform dealings, reliance on user-supplied information, or a user's failure to perform adequate due diligence, including indirect, incidental, special, consequential, exemplary, or punitive loss, loss of income, opportunity, reputation, data, or business. Nothing in these terms excludes or limits liability that cannot lawfully be excluded or limited.</p></section>
              <section id="terms-indemnity"><h2>Indemnity</h2><p>To the fullest extent permitted by applicable law, each user agrees to defend, indemnify, and hold harmless the Platform Parties from third-party claims, proceedings, liabilities, losses, damages, penalties, and reasonable costs and expenses arising from or connected with that user's content, representations, conduct, off-platform dealings, employment or locum arrangements, breach of these terms, infringement of another person's rights, or violation of applicable law. This obligation does not apply to the extent a claim results from liability of a Platform Party that applicable law does not permit to be excluded or indemnified.</p></section>
