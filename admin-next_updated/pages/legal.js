...
const defaultPages = {
  ...
  terms: {
    ...
    htmlContent: '<article class="legal-page-shell"><header class="legal-hero"><h1>Terms and Conditions</h1><p>Set the rules for professionals, employers, admins, feed participation, billing, verification, and platform enforcement.</p></header><div class="legal-grid"><aside class="legal-nav"><a href="#accounts">Accounts</a><a href="#billing">Billing</a><a href="#moderation">Moderation</a></aside><div class="legal-content-card"><section id="accounts"><h2>Accounts</h2><p>Users must provide accurate information and keep profile, facility, and verification records current.</p></section><section id="billing"><h2>Billing</h2><p>Subscriptions, pay-as-you-go rules, free allowances, payment requests, and manual upgrades are governed by admin configuration.</p></section><section id="moderation"><h2>Moderation</h2><p>Admins may remove content, flag jobs, archive audit logs, end sessions, and enforce platform rules.</p></section></div></div></article>',
    cssContent: defaultCss,
    sourceType: 'Html',
    documentUrl: '',
    documentFileName: '',
